...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="col-md-8">
		...
		<div class="entry-content">
			...
			?>
			<?php if (get_field('dodajte_vas_casopis_ovde')!=''){?>
			<a class="post-button-green document-icon-button" href="<?php the_field('dodajte_vas_casopis_ovde'); ?>" target="_blank">Pogledajte časopis</a>
			<?php } ?>
		</div><!-- .entry-content -->
