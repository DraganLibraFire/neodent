...
/**
 * Clean nav walker class
 * This walker class will generate a clean unordered list.
 * It removes the numerous classes added to each list item by the default WordPress
 * but will keep any custom classes that have been added directly via the menus admin.
 * 
 * @since 1.0.0
 * @category walkers
 * @group classes
